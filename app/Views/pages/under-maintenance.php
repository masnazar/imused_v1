...
<?= $this->extend('layouts/custom-main1'); ?>
                    ...
                    <div class="aunthentication-cover-content text-center">
                        <div class="row justify-content-center align-items-center mx-0 g-0">
                            <div class="col-xxl-11 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                                <div>
                                    <div class="mb-4"> <a href="<?php echo base_url('index'); ?>"> 
                                        <img src="<?php echo base_url('assets/images/brand-logos/toggle-logo.png'); ?>" alt="" class="authentication-brand"> </a> 
                                    </div>
...
<?= $this->section('scripts'); ?>
        ...
        <!-- Anime JS -->
        <script src="<?php echo base_url('assets/libs/animejs/lib/anime.min.js'); ?>"></script>
