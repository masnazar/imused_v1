                        ...
                        <div class="card-body p-5">
                            <div class="mb-3 d-flex justify-content-center">
                                <a href="<?php echo base_url('index'); ?>">
                                    <img alt="logo" class="desktop-logo" src="<?php echo base_url('assets/images/brand-logos/desktop-logo.png'); ?>"> 
                                    <img alt="logo" class="desktop-white" src="<?php echo base_url('assets/images/brand-logos/desktop-white.png'); ?>">
                                </a>
                            </div>
                            ...
                            <div class="text-center">
                                <p class="text-muted mt-3 mb-0">Back to home ? <a class="text-primary" href="<?php echo base_url('index'); ?>">Click Here</a></p>
                            </div>
                        </div>
                    </div>
                </div>
