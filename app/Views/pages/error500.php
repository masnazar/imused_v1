...
<?= $this->extend('layouts/custom-main4'); ?>
                    ...
                    <div class="my-auto">
                        <div class="row align-items-center justify-content-center h-100">
                            <div class="col-xl-7 col-lg-5 col-md-6 col-12">
                                ...
                                <a href="<?php echo base_url('index'); ?>" class="btn btn-primary"><i class="ri-arrow-left-line align-middle me-1 d-inline-block"></i> BACK TO HOME PAGE</a>
                            </div>
                        </div>
                    </div>
                </div>
