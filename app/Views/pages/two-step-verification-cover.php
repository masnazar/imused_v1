                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="form-check mt-2">
                                            ...
                                            <label class="form-check-label fs-14" for="defaultCheck1">
                                                Didn't recieve a code ?<a href="<?php echo base_url('mail'); ?>" class="text-primary ms-2 d-inline-block">Resend</a>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 d-grid mt-2">
                                        <a href="<?php echo base_url('index'); ?>" class="btn btn-primary">Verify</a>
                                    </div>
                                </div>
                            </div>
                        </div>
