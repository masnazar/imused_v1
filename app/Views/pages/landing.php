                            ...
                            <div class="row pt-3">
                                <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                    <div class="pt-lg-5 pb-4">
                                        ...
                                        <a href="<?php echo base_url('index'); ?>" class="m-1 btn btn-lg bg-white-transparent">
                                            View Demos
                                ...
                                <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4 my-auto">
                                    <div class="text-end landing-main-image landing-heading-img">
                                        <img src="<?php echo base_url('assets/images/media/landing/1.png'); ?>" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gx-5 mx-0">
                            <div class="col-xl-5">
                                <div class="home-proving-image">
                                    <img src="<?php echo base_url('assets/images/media/landing/2.png'); ?>" alt="" class="img-fluid] about-image d-none d-xl-block">
                                </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xl-10 my-auto">
                                <div
                                    ...
                                    <div class="trust-img"><img src="<?php echo base_url('assets/images/media/landing/web/1.png'); ?>" alt="img"
                                            class="border-0 shadow-sm"></div>
                                    <div class="trust-img"><img src="<?php echo base_url('assets/images/media/landing/web/2.png'); ?>" alt="img"
                                            class="border-0 shadow-sm"></div>
                                    <div class="trust-img"><img src="<?php echo base_url('assets/images/media/landing/web/4.png'); ?>" alt="img"
                                            class="border-0 shadow-sm"></div>
                                    <div class="trust-img"><img src="<?php echo base_url('assets/images/media/landing/web/5.png'); ?>" alt="img"
                                            class="border-0 shadow-sm"></div>
                                    <div class="trust-img"><img src="<?php echo base_url('assets/images/media/landing/web/6.png'); ?>" alt="img"
                                            class="border-0 shadow-sm"></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="mb-4 lh-1 d-flex gap-2 justify-content-center">
                                            <span class="avatar avatar-xl avatar-rounded bg-success">
                                                <img src="<?php echo base_url('assets/images/faces/11.jpg'); ?>" class="card-img" alt="...">
                                            </span>
                                        </div>
                                        <div class="">
                                                ...
                                                <div class="p-3 bg-white-transparent">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="<?php echo base_url('assets/images/faces/8.jpg'); ?>" alt="" class="img-fluid rounded-circle border border-primary1 shadow-sm border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="p-3 bg-white-transparent">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="<?php echo base_url('assets/images/faces/9.jpg'); ?>" alt="" class="img-fluid rounded-circle border border-primary1 shadow-sm border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="p-3 bg-white-transparent">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="<?php echo base_url('assets/images/faces/6.jpg'); ?>" alt="" class="img-fluid rounded-circle border border-primary1 shadow-sm border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="p-3 bg-white-transparent">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="<?php echo base_url('assets/images/faces/14.jpg'); ?>" alt="" class="img-fluid rounded-circle border border-primary1 shadow-sm border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="p-3 bg-white-transparent">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="<?php echo base_url('assets/images/faces/13.jpg'); ?>" alt="" class="img-fluid rounded-circle border border-primary1 shadow-sm border-2">
                                                        </span>
                                                        <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card overflow-hidden">
                                                ...
                                                <div class="p-3 bg-white-transparent">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar rounded-circle me-2">
                                                            <img src="<?php echo base_url('assets/images/faces/11.jpg'); ?>" alt="" class="img-fluid rounded-circle border border-primary1 shadow-sm border-2">
                                                        </span>
                                                        <div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                                <div class="px-4">
                                    <p class="fw-medium mb-3"><a href="<?php echo base_url('index'); ?>"><img
                                                src="<?php echo base_url('assets/images/brand-logos/desktop-dark.png'); ?>" alt="" class="landing-footer-logo"></a></p>
