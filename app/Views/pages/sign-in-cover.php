                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-12 mb-2">
                                        <label for="signin-password" class="form-label text-default d-block">Password<a href="<?php echo base_url('reset-password-basic'); ?>" class="float-end fw-normal text-muted">Forget password ?</a></label>
                                ...
                                <div class="text-center">
                                    <p class="text-muted mt-3 mb-0">Dont have an account? <a href="<?php echo base_url('sign-up-basic'); ?>" class="text-primary">Sign Up</a></p>
                                </div>
                ...
                <div class="authentication-cover overflow-hidden">
                    <div class="authentication-cover-logo"> 
                        <a href="<?php echo base_url('index'); ?>"> 
                            <img src="<?php echo base_url('assets/images/brand-logos/desktop-white.png'); ?>" alt="" class="authentication-brand desktop-white"> 
                        </a> 
                    </div>
