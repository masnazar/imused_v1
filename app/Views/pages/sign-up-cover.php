                    ...
                    <div class="col-xxl-7 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                        ...
                        <div class="card-body p-5">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-check mt-3">
                                            ...
                                            <a href="<?php echo base_url('terms-conditions'); ?>" class="text-success"><u>Terms & Conditions</u></a> and <a class="text-success"><u>Privacy Policy</u></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <p class="text-muted mt-3 mb-0">Already have an account? <a href="<?php echo base_url('sign-in-basic'); ?>" class="text-primary">Sign In</a></p>
                                </div>
