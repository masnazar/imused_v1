                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="<?php echo base_url('job-post'); ?>" class="btn btn-primary btn-wave btn-sm">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> HTML Developer - Fresher</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> React Lead Developer</a></p>
                                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> Vuejs Frontend Developer</a></p>
                                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> Wordpress Developer - Remote</a></p>
                                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                            </div>
                                                        </div>
                                                    </td>
