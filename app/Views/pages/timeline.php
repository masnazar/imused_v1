                                                                ...
                                                                <div class="timeline-box">
                                                                    ...
                                                                    <p class="profile-activity-media mb-0">
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-17.jpg'); ?>" alt="" class="mb-0">
                                                                        </a>    
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-18.jpg'); ?>" alt="" class="mb-0">
                                                                        </a>    
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="timeline-right">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="timeline-box">
                                                                    ...
                                                                    <p class="profile-activity-media mb-0">
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-59.jpg'); ?>" class="mb-0" alt="">
                                                                        </a>  
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-60.jpg'); ?>" class="mb-0" alt="">
                                                                        </a>  
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-61.jpg'); ?>" class="mb-0" alt="">
                                                                        </a>  
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="timeline-right">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="timeline-box mb-2">
                                                                    ...
                                                                    <p class="profile-activity-media mb-0">
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-26.jpg'); ?>" alt="" class="mb-0">
                                                                        </a>    
                                                                        <a href="javascript:void(0);">
                                                                            <img src="<?php echo base_url('assets/images/media/media-29.jpg'); ?>" alt="" class="mb-0">
                                                                        </a>    
                                                                    </p>
                                                                </div>
                                                            </div>
