                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-5 mb-4 flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="avatar avatar-md p-1 avatar-rounded me-1 bg-primary-transparent"><img src="<?php echo base_url('assets/images/faces/11.jpg'); ?>" alt=""></span>
                                            <div>
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled profile-timeline">
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <p class="profile-activity-media mb-2">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-21.jpg'); ?>" alt="">
                                                    </a>   
                                                </p>
                                                <div>
                                                    <div class="avatar-list-stacked">
                                        ...
                                        <li>
                                            <div>
                                                <span class="avatar avatar-sm shadow-sm avatar-rounded profile-timeline-avatar">
                                                    <img src="<?php echo base_url('assets/images/media/media-45.jpg'); ?>" alt="">
                                                </span>
                                                ...
                                                <p class="profile-activity-media mb-0">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-28.jpg'); ?>" alt="">
                                                    </a>    
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-30.jpg'); ?>" alt="">
                                                    </a>    
                                                </p>
                                            </div>
                                        </li>
