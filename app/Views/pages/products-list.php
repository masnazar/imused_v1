                                        ...
                                        <table class="table text-nowrap table-bordered">
                                            ...
                                            <tbody>
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/30.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-2 fs-15">
                                                            <a href="<?php echo base_url('edit-products'); ?>" class="btn btn-icon btn-sm btn-primary-light"><i class="ri-edit-line"></i></a>
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/14.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/31.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/12.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/32.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/23.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
                                                ...
                                                <tr class="product-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <span class="avatar avatar-md avatar-square bg-light"><img src="<?php echo base_url('assets/images/ecommerce/png/15.png'); ?>" class="w-100 h-100" alt="..."></span>
                                                            <div class="ms-2">
