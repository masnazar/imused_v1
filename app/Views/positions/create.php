    ...
    <div>
        <nav>
            <ol class="breadcrumb mb-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambah Posisi</li>
            </ol>
        </nav>
        <h1 class="page-title fw-medium fs-18 mb-0">Tambah Posisi</h1>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="<?= base_url('positions/store') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="position_name" class="form-control" id="positionName" required>
            </div>
            <div class="mb-3">
                <label for="positionCode" class="form-label">Kode Posisi</label>
                <input type="text" name="position_code" class="form-control" id="positionCode" required>
            </div>
