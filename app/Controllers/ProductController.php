...
class ProductController extends BaseController
{
    ...
    public function getProducts()
    {
        ...
        $columns = ['product_name', 'brand_name', 'product_code', 'product_sku', 'hpp', 'hpp_penjualan', 'total_stock', 'bpom_number', 'supplier_name'];
        $orderColumn = $columns[$orderColumnIndex] ?? 'id';

        // Ambil data dari model
        $totalData = $this->productModel->countAllData();
        $totalFiltered = $this->productModel->countFilteredData($search);
        $data = $this->productModel->getDataTables($search, $start, $length, $orderColumn, $orderDir);
